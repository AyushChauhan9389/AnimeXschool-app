...
>(
  ...
  const insets: EdgeInsets = {
    top: insetsProp?.top ?? safeInsets.top,
    bottom: insetsProp?.bottom ?? safeInsets.bottom,
    left: insetsProp?.left ?? safeInsets.left,
    right: insetsProp?.right ?? safeInsets.right,
  };
  const maxHeight = maxHeightProp ?? screenHeight - insets.top - insets.bottom;
  const maxWidth = maxWidthProp ?? screenWidth - insets.left - insets.right;
